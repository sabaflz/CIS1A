...
void output(ofstream&, string [], string [], int [], int [], int [], double []);
double averageFillRate(int [], int [], int [], double []);
void findBellowMinFillRate(ofstream&, string [], string [], int [], int [], int [], double []);
int search(string[], string);
void sortSelectAccendingFillRates(string [], string [], int [], int [], int [], double []);
void signature();
...
int main()
{
    ...
    /*
     Initialize the fill rates with -1 to handle
     the data when the number of courses is less than MAX
    */
    for(int i = 0; i < MAX; i++)
    {
        fill_rates[i] = -1;
    ...
    cin >> target_crn;
    location = search(course_CRN_number, target_crn);
    ...
    {
        cout << "Info about the class with this CRN:" << endl;
        cout << "Name: " << class_name[location] << endl;
        cout << "Fill Rate: " << fill_rates[location] << endl;
    }
...
void output(ofstream& outputFile, string crn[], string title[], int enrolled[],
            int max_size[], int waitlisted[], double fill_rate[])
{
    /*
        Pre:
...
//------------------------------------ search() -------------------------------------
int search(string crn[], string target_crn)
{
    /*
        Pre:
            crn[]       : Array of CRN# of the courses read from the input file (Fall2023.txt)
