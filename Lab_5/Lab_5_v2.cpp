                  ...
                  double& minimum_income)
{
    /*
        ...
        Purpose:
            Call the calcDownLoanMortgage function to calculate:
            - The amount of down payment
            - The amount of loan needed
            - The amount of monthly mortgage payment
            Also calculate :
            - The amount of property taxes based on the selling price
              provided by the user and the annual tax rate,
            - Total costs of the house by
              adding up the mortgage, taxes and insurance expenses
            - Minimum income needed using the total costs and the
    ...
    */
    ...
    property_taxes = selling_price * TAX_RATE / 12;
    // monthly insurance
                          ...
                          double& monthly_mortgage_payment)
{
    /*
        ...
        Purpose:
            Calculate :
            - The down payment will be 20% of selling price provided by the user
            - The amount of loan needed
            - The amount of monthly mortgage payment using the formula bellow:
            ...
            double minimum_income)
{
    /*
        ...
        Purpose:
            Print all the cost information (values used or calculated) for the user
    */
...
/*
 ...
 MINIMUM MONTHLY INCOME                  $ 10600.49
...
/*
 ...
 MINIMUM MONTHLY INCOME                  $ 16167.45
